...
<def title="Master Lumberjack">

Verringert den Cooldown des [Lumberjack](custom-enchantments.md) Enchantments um <tooltip term="depends-on-level">`0 → 15 Sekunden`</tooltip>
